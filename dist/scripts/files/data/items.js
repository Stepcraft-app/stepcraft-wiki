...
export const toolTiers = ['copper', 'iron', 'silver', 'gold', 'blue', 'red'];
// Map tool keys to their tiers
export const toolKeyToTier = {
...
export const doesToolMeetRequirement = (equippedToolKey, requiredTier) => {
    if (!requiredTier)
        return true; // No tool requirement
    if (!equippedToolKey)
        return false;
    const equippedTier = toolKeyToTier[equippedToolKey];
    if (!equippedTier)
        return false;
