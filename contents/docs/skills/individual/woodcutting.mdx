...
Master these 3 recipes to advance your Logging skill:

### Recipe List

| Recipe | Level | Tool | Inputs | Outputs | XP | Steps |
|:-------|:-----:|:----:|:-------|:--------|:--:|:-----:|
| **Gather Sticks** | - | - | None | 1x Sticks | 10 | 50 |
| **Cut Birch Log** | Lv. 15 | - | None | 1x Birch Log | 20 | 75 |
| **Cut Oak Log** | Lv. 30 | - | None | 1x Oak Log | 40 | 100 |
