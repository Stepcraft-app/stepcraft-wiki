...
<div className="flex items-start gap-6 mb-8">
  <div className="flex-shrink-0">
    <img src="/assets/resources/hunting/mouse_hide.png" alt="Mouse Hide" className="w-24 h-24 border rounded-lg" />
  </div>
...
**Level Requirement:** 5 | **Drop Rate:** 50%


**Required Materials:**
- 2x [Mouse](/docs/resources/individual/mouse)
