...
Harvested through **Logging** - obtained from trees in forests and wooded areas. This resource requires Woodcutting level 32 and a iron axe.
...
|--------|-------|-------|------|----|-------|--------|
| **[Chop Pine Log](/docs/skills/individual/woodcutting#pine_log)** | Woodcutting | Lv. 32 | iron | 48 | 120 | 1x Pine Log |
