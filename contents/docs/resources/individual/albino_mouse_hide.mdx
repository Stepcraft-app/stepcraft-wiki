---
title: Albino Mouse Hide
lastVerified: 2026-06-12
---

<div className="flex items-start gap-6 mb-8">
  <div className="flex-shrink-0">
    <img src="/assets/resources/hunting/albino_mouse_hide.png" alt="Albino Mouse Hide" className="w-24 h-24 border rounded-lg" />
  </div>
...
**Level Requirement:** 8 | **Drop Rate:** 50%


**Required Materials:**
- 2x [Albino Mouse](/docs/resources/individual/albino_mouse)
