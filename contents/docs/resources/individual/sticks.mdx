...
Harvested through **Logging** - obtained from trees in forests and wooded areas. This basic resource requires no special tools and can be harvested by beginners.
...
|--------|-------|-------|------|----|-------|--------|
| **[Chop Sticks](/docs/skills/individual/woodcutting#sticks)** | Woodcutting | - | - | 10 | 50 | 2x Sticks |
