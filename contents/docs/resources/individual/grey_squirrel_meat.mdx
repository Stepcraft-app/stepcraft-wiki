---
title: Grey Squirrel Meat
lastVerified: 2026-06-14
---

<div className="flex items-start gap-6 mb-8">
  <div className="flex-shrink-0">
    <img src="/assets/resources/hunting/squirrel_meat.png" alt="Grey Squirrel Meat" className="w-24 h-24 border rounded-lg" />
  </div>
...
**Required Materials:**
- 1x [Grey Squirrel](/docs/resources/individual/grey_squirrel)
